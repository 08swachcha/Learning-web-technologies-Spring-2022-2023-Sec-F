...
<h1 style="text-align: center;">
	Doctor's Portal Patients Login
</h1>
...
<button onclick="document.location='welcome.php'"> Go back</button>
  ...
  <br>
<fieldset>
  <form name="login" method="POST" action="../controller/patient/logincontroller.php" onsubmit="return validateForm()" >
	<fieldset>
    <legend>Login:</legend>
  ...
  <center> <br> Not Registered ?<br><a href ="formreg.php"> Click here</a> <br>to register  </center>
