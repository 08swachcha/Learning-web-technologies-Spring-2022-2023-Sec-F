...
<button onclick="document.location='welcome.php'"> Go back</button>
  ...
  <br>
<fieldset>
  <form name="login" onsubmit="return validateForm()" method="POST" action="../controller/doctor/logincontroller.php">
	<fieldset>
    <legend>Login:</legend>
    ...
    <input type="text" id="type" name="type" value="doctor" hidden><br>
    <br>
